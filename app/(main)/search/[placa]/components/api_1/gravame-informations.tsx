        ...
        <div className='container-fluid'>
            ...
            <div className='row mt-3 mb-3'>
                <div className='col-12 col-md-4 mb-3 mb-md-0'>
                    <h3 className='h5 text-primary font-weight-bold'>Financiamento:</h3>
                    <p></p>
                </div>
                <div className='col-12 col-md-4 mb-3 mb-md-0'>
                    <h3 className='h5 text-primary font-weight-bold'>Financeira:</h3>
                    <p></p>
                </div>
                <div className='col-12 col-md-4'>
                    <h3 className='h5 text-primary font-weight-bold'>Arrendatario:</h3>
                    <p></p>
                </div>
            </div>
            ...
            <div className='row mt-3 mb-3'>
                <div className='col-12'>
                    <h3 className='h5 text-primary font-weight-bold'>Data de inclusão:</h3>
                    <p></p>
                </div>
            </div>
        </div>
